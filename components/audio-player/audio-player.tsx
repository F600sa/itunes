...
export default function AudioPlayer({
  ...
  return (
    <div
      ...
      className=" text-white justify-between flex flex-row items-center px-4 py-2 space-y-2 md:space-y-0 md:space-x-6"
    >
      ...
      <div className="flex flex-col justify-center items-center divide-y divide-gray-600">
        ...
        <div className="flex items-center space-x-2 py-1 px-3">
          <FaVolumeUp />
          <button onClick={() => adjustVolume(-0.1)} className="px-1 hover:bg-white/10 rounded">
            −
          </button>
        ...
        {/* rate */}
        <div className="flex items-center space-x-2 py-1 px-3">
          <button onClick={() => changeRate(-0.25)} className="px-1 hover:bg-white/10 rounded">
            −
          </button>
        ...
        <div className="py-1 px-3">
          <button onClick={handleStop} title="STOP" className="text-xl hover:text-red-500">
            <FaStop />
          </button>
        </div>
      </div>
